	...
	<div class="privacy">
		<div class="container">
			...
			<?php
				...
				else if($totalPrice < 200000 && isset($_SESSION['user'])){ ?>
				<div class="applyCoupon">
					<button class="btnAddCoupon" style="transition: .5s all; margin-bottom: 10px;" type="button" title="Total Price must exceed 200000VND to apply voucher" disabled>Apply Voucher</button>				
				</div>
				<?php }
				else { ?>
				<div class="applyCoupon">
					<button class="btnAddCoupon" style="transition: .5s all; margin-bottom: 10px;" type="button" title="Login is required to use this function" disabled>Apply Voucher</button>				
				</div>
				<?php }
			?>
