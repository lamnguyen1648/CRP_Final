...
?>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"><?php echo 'Product'?>
			...
			<div class="side-bar col-md-3">
				...
				<h3 class="agileits-sear-head">Newly Added</h3>
				<?php
					$sql = "SELECT * FROM tbl_product ORDER BY productID DESC LIMIT 6"; // sql command
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
					...
					if(mysqli_num_rows($result) > 0) {
						...
						<h3 style="text-align: center;">No product found matching query: <?php echo $search?></h3>
					<?php }
					?>
						<div class="clearfix"></div>
					</div>
