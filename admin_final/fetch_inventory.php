...
if(isset($_POST['query'])) {
    ...
    $sql = "SELECT * FROM tbl_product INNER JOIN tbl_product_category
            ON tbl_product_category.categoryID = tbl_product.categoryID
    ...
    foreach($query as $rows) {
        ...
        $output .= '
                <tr>
                    ...
                    <td class='.$text_class.'>'.$rows['productStatus'].'</td>
