...
$id = $_GET['id'];
$display_sql = mysqli_query($conn, "SELECT * FROM tbl_product INNER JOIN tbl_product_category ON tbl_product.categoryID = tbl_product_category.categoryID WHERE productID = '$id'");
